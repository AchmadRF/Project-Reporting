...
export default function Welcome() {
  ...
  //       <h1 className="text-5xl font-bold mb-4">Welcome to My Reporting App</h1>
  //       <p className="text-xl mb-8">Built with Laravel, React, and Inertia</p>
  //       <Link
  //         href="/dashboard"
  //         className="bg-white text-blue-600 px-6 py-3 rounded-full font-semibold hover:bg-blue-100 transition duration-300 inline-flex items-center"
  //       >
  //         Get Started
